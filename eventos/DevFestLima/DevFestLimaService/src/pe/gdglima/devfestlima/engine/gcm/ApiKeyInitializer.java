 ...
 */
package pe.gdglima.devfestlima.engine.gcm;
...
public class ApiKeyInitializer implements ServletContextListener {
    ...
    static final String FAKE_API_KEY = "AIzaSyAjJfgcAuIdyUNXn8ALxWDBJVu94fxmTAM";

    static final String ATTRIBUTE_ACCESS_KEY = "AIzaSyAjJfgcAuIdyUNXn8ALxWDBJVu94fxmTAM";

    private static final String ENTITY_KIND = "Settings";
    private static final String ENTITY_KEY = "MyKey";
    private static final String ACCESS_KEY_FIELD = "AIzaSyAjJfgcAuIdyUNXn8ALxWDBJVu94fxmTAM";
